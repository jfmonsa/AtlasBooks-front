        ...
        <footer className={styles.footer}>
            <div className={styles.infoContainer}>
                ...
                <div>
                    ...
                    <a href="#">
                        <svg className={styles.infoContainer__icon} width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
